        ...
        protected void generate() {
            ...
            add(GSBlocks.PYROLYTIC_ASH.get(), LootTable.lootTable()
                ...
                .withPool(this.applyExplosionCondition(Items.CHARCOAL.asItem(), LootPool.lootPool()
                    ...
                    .add(LootItem.lootTableItem(Items.CHARCOAL.asItem())
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.PYROLYTIC_ASH.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PyrolyticAshBlock.ASH_TYPE, AshType.CHARCOAL)))
                    )))
                .withPool(this.applyExplosionCondition(GSItems.COKE.asItem(), LootPool.lootPool()
                    ...
                    .add(LootItem.lootTableItem(GSItems.COKE.asItem())
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.PYROLYTIC_ASH.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PyrolyticAshBlock.ASH_TYPE, AshType.COKE)))
                    )))
            );
            ...
            add(GSBlocks.COMPOST_PILE.get(), LootTable.lootTable()
                .withPool(this.applyExplosionCondition(GSItems.COMPOST_PILE.asItem(), LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    .add(LootItem.lootTableItem(GSItems.COMPOST_PILE.asItem())
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.COMPOST_PILE.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CompostBlock.AGE, 0)))
                    )))
                .withPool(this.applyExplosionCondition(GSItems.COMPOST_PILE.asItem(), LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    .add(LootItem.lootTableItem(GSItems.COMPOST_PILE.asItem())
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.COMPOST_PILE.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CompostBlock.AGE, 1)))
                    )))
                .withPool(this.applyExplosionCondition(GSItems.COMPOST_PILE.asItem(), LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    .add(LootItem.lootTableItem(GSItems.COMPOST_PILE.asItem())
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.COMPOST_PILE.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CompostBlock.AGE, 2)))
                    )))
                .withPool(this.applyExplosionCondition(GSItems.COMPOST_PILE.asItem(), LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    .add(LootItem.lootTableItem(GSItems.COMPOST_PILE.asItem())
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.COMPOST_PILE.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CompostBlock.AGE, 3)))
                    )))
                .withPool(this.applyExplosionCondition(GSItems.COMPOST.asItem(),  LootPool.lootPool()
                    ...
                    .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CompostBlock.AGE, 4))))
                ));
            /*
            ...
            for(DeferredBlock<StainedGlassPaneBlock> block : GSBlocks.STAINED_FRAMED_GLASS_PANES)
                dropWhenSilkTouch(block.get());
            // Candelabras
            add(GSBlocks.CANDELABRA.get(), LootTable.lootTable()
                .withPool(this.applyExplosionCondition(GSBlocks.CANDELABRA, LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                    .add(LootItem.lootTableItem(GSBlocks.CANDELABRA)
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.CANDELABRA.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CandelabraBlock.CANDLES, 1)))
                    )))
                .withPool(this.applyExplosionCondition(GSBlocks.CANDELABRA, LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    ...
                    .add(LootItem.lootTableItem(GSBlocks.CANDELABRA)
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.CANDELABRA.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CandelabraBlock.CANDLES, 2)))
                    )))
                .withPool(this.applyExplosionCondition(GSBlocks.CANDELABRA, LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    ...
                    .add(LootItem.lootTableItem(GSBlocks.CANDELABRA)
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.CANDELABRA.get())
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CandelabraBlock.CANDLES, 3)))
                    )))
                .withPool(this.applyExplosionCondition(GSBlocks.CANDELABRA, LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0F))
                    ...
                    .add(LootItem.lootTableItem(GSBlocks.CANDELABRA)
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(GSBlocks.CANDELABRA.get())
                            .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CandelabraBlock.CANDLES, 4)))
                    )))
            );
